<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                <a href="{{ route('hospital') }}" class="menu-link">
                    <div data-i18n="Without menu">Hospitel-History</div>
                </a>
                </li>
            </ul>
            <ul class="menu-sub">
                <li class="menu-item">
                <a href="{{ route('managementteam') }}" class="menu-link">
                    <div data-i18n="Without menu">Management-Team</div>
                </a>
                </li>
            </ul>
            <ul class="menu-sub">
                ...
                <a href="{{ route('management') }}" class="menu-link">
                    <div data-i18n="Without menu">Management-Team-photo</div>
                </a>
                </li>
            </ul>
            <ul class="menu-sub">
                <li class="menu-item">
                <a href="{{ route('qualitypolicy') }}" class="menu-link">
                    <div data-i18n="Without menu">Quality-Policy</div>
                </a>
                </li>
            </ul>
            <ul class="menu-sub">
                <li class="menu-item">
                <a href="{{ route('quality.politcy') }}" class="menu-link">
                    <div data-i18n="Without menu">Quality-Policy-image</div>
                </a>
                </li>
            </ul>
            <ul class="menu-sub">
                <li class="menu-item">
                <a href="{{ route('shipcountry') }}" class="menu-link">
                    <div data-i18n="Without menu">Ship-county</div>
                </a>
                </li>
            </ul>
        </li>
      ...
      <li class="menu-item">
        ...
        <li class="menu-item">
            ...
            <ul class="menu-sub">
                ...
                <li class="menu-item">
                    <a href="{{route('ourproduct')}}" class="menu-link">
                        <div data-i18n="Without menu">Our Product </div>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="{{route('product.detalis')}}" class="menu-link">
                        <div data-i18n="Without menu">Product Details</div>
                    </a>
                </li>
            </ul>
        </li>
      ...
      <li class="menu-item">
        <a href="javascript:void(0);" class="menu-link menu-toggle">
          <i class="menu-icon tf-icons bx bxs-user-badge"></i>
          <div data-i18n="Layouts">pricing</div>
        </a>

        <ul class="menu-sub">
          <li class="menu-item">
            <a href="{{route('pricing')}}" class="menu-link">
              <div data-i18n="Without menu">Free Quote</div>
            </a>
          </li>
        </ul>
        ...
        <ul class="menu-sub">
            <li class="menu-item">
              <a href="{{route('pricing.show')}}" class="menu-link">
                <div data-i18n="Without menu">Free Quote photo </div>
              </a>
            </li>
          </ul>
      </li>
