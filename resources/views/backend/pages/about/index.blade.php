        ...
        <div class="card-body">
            ...
            @endif
                ...
                <div class="mb-3">
                  ...
                  <textarea id="editor1" class="form-control" name="description" placeholder="Write Here....." style="display: block !important;" hidden>@if( !empty( $about ) ){{ $about->description }}@endif</textarea>
                </div>
